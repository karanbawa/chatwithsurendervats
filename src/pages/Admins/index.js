...
const Admins = props => {
  ...
  //meta title
  document.title = "Admins | TWT -Train With Trainer";
  ...
  const validation = useFormik({
    ...
    initialValues: {
      ...
      role: (customer && customer.sendEmailToUser) || '',
    },
    validationSchema: Yup.object({
      ...
      role: Yup.string().required("Please Enter Your Rating")
    }),
    onSubmit: (values) => {
      if (isEdit) {
        const updateAdmin = {
              ...
              <Card>
                <CardBody>
                  <TableContainer
                    ...
                    data={customers}
                    isGlobalFilter={true}
                    isAddAdminDetails={true}
                    handleAdminClicks={handleAdminClicks}
                    customPageSize={10}
                        ...
                        <Row>
                          <Col className="col-12">
                            ...
                            <div className="mb-3">
                              ...
                              <div>
                                <select name="role" id="role" onChange={validation.handleChange}
                                  value={validation.values.role} className="form-control">
